                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="breadcrumb__content">
                            <h1 class="breadcrumb__content--title text-white mb-10">Bits Interior Design</h1>
                            <ul class="breadcrumb__content--menu d-flex">
                                <li class="breadcrumb__content--menu__items"><a class="text-white" href="/">Home</a></li>
                                <li class="breadcrumb__content--menu__items"><span class="text-white">Bits Interior Design Shop</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="shop__sidebar--widget widget__area d-md-none">
                                ...
                                <ul class="widget__categories--menu">
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="{{ asset('images/product/small-product1.webp') }}" alt="categories-img">
                                            <span class="widget__categories--menu__text">Living Room Furniture</span>
                                    ...
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="{{ asset('images/product/small-product2.webp') }}" alt="categories-img">
                                            <span class="widget__categories--menu__text">Office Furniture</span>
                                            <svg class="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" >
                                                <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="{{ asset('images/product/small-product3.webp') }}" alt="categories-img">
                                            <span class="widget__categories--menu__text">Bathroom Designss</span>
                                            <svg class="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
                                                <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                            </svg>
                                        </label>
                                    ...
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="{{ asset('images/product/small-product4.webp') }}" alt="categories-img">
                                            <span class="widget__categories--menu__text">Interiror Design</span>
                                            <svg class="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
                                                <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                            </svg>
                                        </label>
                                    ...
                                    {{-- <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="{{ asset('images/product/small-product5.webp') }}" alt="categories-img">
                                    ...
                                    <div class="price__filter--form__inner mb-15 d-flex align-items-center">
                                        <div class="price__filter--group">
                                            ...
                                            <div class="price__filter--input border-radius-5 d-flex align-items-center">
                                                <span class="price__filter--currency">UGx</span>
                                ...
                                <div class="product__grid--inner">
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        <div class="product__items--grid__thumbnail position__relative">
                                            <a class="product__items--link" href="{{ route('product.detail') }}">
                                                <img class="product__items--img product__primary--img" src="{{ asset('images/product/small-product1.webp') }}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{ asset('images/product/small-product2.webp') }}" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__items--grid__content">
                                            <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Modern Chair</a></h3>
                                            <div class="product__items--price">
                                                <span class="current__price">UGx165.00</span>
                                            </div>
                                    ...
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        <div class="product__items--grid__thumbnail position__relative">
                                            <a class="product__items--link" href="{{ route('product.detail') }}">
                                                <img class="product__items--img product__primary--img" src="{{ asset('images/product/small-product3.webp') }}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{ asset('images/product/small-product4.webp') }}" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__items--grid__content">
                                            <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Plastic Chair</a></h3>
                                            <div class="product__items--price">
                                                <span class="current__price">UGx165.00</span>
                                            </div>
                                            <div class="product__items--color">
                                    ...
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        <div class="product__items--grid__thumbnail position__relative">
                                            <a class="product__items--link" href="{{ route('product.detail') }}">
                                                <img class="product__items--img product__primary--img" src="{{ asset('images/product/small-product5.webp') }}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{ asset('images/product/small-product6.webp') }}" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__items--grid__content">
                                            <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Design Rooms</a></h3>
                                            <div class="product__items--price">
                                                <span class="current__price">UGx165.00</span>
                                            </div>
                                            <div class="product__items--color">
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <ul class="widget__tagcloud">
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#">Wooden</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#">Chair</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#">Modern</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#">Fabric  </a></li>
                                    ...
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#">Accessories</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row row-cols-xxl-4 row-cols-xl-3 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="{{ route('product.detail') }}">
                                                            <img class="product__items--img product__primary--img" src="{{ asset('images/product/product1.webp') }}" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="{{ asset('images/product/product2.webp') }}" alt="product-img">
                                                        </a>
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Fashion Plastic Chair</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx1,500,000.00</span>
                                                            {{-- <span class="old__price">UGx200.00</span> --}}
                                                        </div>
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="{{ route('product.detail') }}">
                                                            <img class="product__items--img product__primary--img" src="{{ asset('images/product/product3.webp') }}" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="{{ asset('images/product/product4.webp') }}" alt="product-img">
                                                        </a>
                                                        <ul class="product__items--action d-flex justify-content-center">
                                                            <li class="product__items--action__list">
                                                                <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Modern Swivel Chair</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx800,000.00</span>
                                                            {{-- <span class="old__price">UGx210.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                                                <path  d="M16.84,8.082V6.091a4.725,4.725,0,1,0-9.449,0v4.725a.675.675,0,0,0,1.35,0V9.432h5.4V8.082h-5.4V6.091a3.375,3.375,0,0,1,6.75,0v4.691a.675.675,0,1,0,1.35,0V9.433h3.374V21.581H4.017V9.432H6.041V8.082H2.667V21.641a1.289,1.289,0,0,0,1.289,1.29h16.32a1.289,1.289,0,0,0,1.289-1.29V8.082Z" transform="translate(-2.667 -1.366)" fill="currentColor"></path>
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="{{ route('product.detail') }}">
                                                            <img class="product__items--img product__primary--img" src="{{ asset('images/product/product5.webp') }}" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="{{ asset('images/product/product6.webp') }}" alt="product-img">
                                                        </a>
                                                        <div class="product__badge">
                                                            <span class="product__badge--items sale">New</span>
                                                        </div>
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Design Living Sofa</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx400,000.00</span>
                                                            {{-- <span class="old__price">UGx205.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                                                <path  d="M16.84,8.082V6.091a4.725,4.725,0,1,0-9.449,0v4.725a.675.675,0,0,0,1.35,0V9.432h5.4V8.082h-5.4V6.091a3.375,3.375,0,0,1,6.75,0v4.691a.675.675,0,1,0,1.35,0V9.433h3.374V21.581H4.017V9.432H6.041V8.082H2.667V21.641a1.289,1.289,0,0,0,1.289,1.29h16.32a1.289,1.289,0,0,0,1.289-1.29V8.082Z" transform="translate(-2.667 -1.366)" fill="currentColor"></path>
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="{{ route('product.detail') }}">
                                                            <img class="product__items--img product__primary--img" src="{{ asset('images/product/product7.webp') }}" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="{{ asset('images/product/product8.webp') }}" alt="product-img">
                                                        </a>
                                                        <ul class="product__items--action d-flex justify-content-center">
                                                            <li class="product__items--action__list">
                                                                <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Plastic Chair Wooden</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx600,000.00</span>
                                                            {{-- <span class="old__price">UGx200.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="{{ route('product.detail') }}">
                                                            <img class="product__items--img product__primary--img" src="{{ asset('images/product/product9.webp') }}" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="{{ asset('images/product/product10.webp') }}" alt="product-img">
                                                        </a>
                                                        <div class="product__badge">
                                                            <span class="product__badge--items sale">New</span>
                                                        </div>
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Folding Tables Chairs</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx175,000.00</span>
                                                            {{-- <span class="old__price">UGx190.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                                                <path  d="M16.84,8.082V6.091a4.725,4.725,0,1,0-9.449,0v4.725a.675.675,0,0,0,1.35,0V9.432h5.4V8.082h-5.4V6.091a3.375,3.375,0,0,1,6.75,0v4.691a.675.675,0,1,0,1.35,0V9.433h3.374V21.581H4.017V9.432H6.041V8.082H2.667V21.641a1.289,1.289,0,0,0,1.289,1.29h16.32a1.289,1.289,0,0,0,1.289-1.29V8.082Z" transform="translate(-2.667 -1.366)" fill="currentColor"></path>
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="{{ route('product.detail') }}">
                                                            <img class="product__items--img product__primary--img" src="{{ asset('images/product/product11.webp') }}" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="{{ asset('images/product/product12.webp') }}" alt="product-img">
                                                        </a>
                                                        <ul class="product__items--action d-flex justify-content-center">
                                                            <li class="product__items--action__list">
                                                                <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Modern Fabric Chair</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx465,000.00</span>
                                                            {{-- <span class="old__price">UGx210.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="{{ route('product.detail') }}">
                                                            <img class="product__items--img product__primary--img" src="{{ asset('images/product/product13.webp') }}" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="{{ asset('images/product/product14.webp') }}" alt="product-img">
                                                        </a>
                                                        <div class="product__badge">
                                                            <span class="product__badge--items sale">New</span>
                                                        </div>
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Globe Electric Lamp</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx145,000.00</span>
                                                            {{-- <span class="old__price">UGx185.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                                                <path  d="M16.84,8.082V6.091a4.725,4.725,0,1,0-9.449,0v4.725a.675.675,0,0,0,1.35,0V9.432h5.4V8.082h-5.4V6.091a3.375,3.375,0,0,1,6.75,0v4.691a.675.675,0,1,0,1.35,0V9.433h3.374V21.581H4.017V9.432H6.041V8.082H2.667V21.641a1.289,1.289,0,0,0,1.289,1.29h16.32a1.289,1.289,0,0,0,1.289-1.29V8.082Z" transform="translate(-2.667 -1.366)" fill="currentColor"></path>
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="{{ route('product.detail') }}">
                                                            <img class="product__items--img product__primary--img" src="{{ asset('images/product/product15.webp') }}" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="{{ asset('images/product/product1.webp') }}" alt="product-img">
                                                        </a>
                                                        <ul class="product__items--action d-flex justify-content-center">
                                                            <li class="product__items--action__list">
                                                                <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Fashion Plastic Chair</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx350,000.00</span>
                                                            {{-- <span class="old__price">UGx200.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="{{ route('product.detail') }}">
                                                            <img class="product__items--img product__primary--img" src="{{ asset('images/product/product14.webp') }}" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="{{ asset('images/product/product2.webp') }}" alt="product-img">
                                                        </a>
                                                        <div class="product__badge">
                                                            <span class="product__badge--items sale">New</span>
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Design Rooms Sofa</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx555,000.00</span>
                                                            {{-- <span class="old__price">UGx215.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                                                <path  d="M16.84,8.082V6.091a4.725,4.725,0,1,0-9.449,0v4.725a.675.675,0,0,0,1.35,0V9.432h5.4V8.082h-5.4V6.091a3.375,3.375,0,0,1,6.75,0v4.691a.675.675,0,1,0,1.35,0V9.433h3.374V21.581H4.017V9.432H6.041V8.082H2.667V21.641a1.289,1.289,0,0,0,1.289,1.29h16.32a1.289,1.289,0,0,0,1.289-1.29V8.082Z" transform="translate(-2.667 -1.366)" fill="currentColor"></path>
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="{{ route('product.detail') }}">
                                                            <img class="product__items--img product__primary--img" src="{{ asset('images/product/product6.webp') }}" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="{{ asset('imagesproduct/product5.webp') }}" alt="product-img">
                                                        </a>
                                                        <div class="product__badge">
                                                            <span class="product__badge--items sale">New</span>
                                                        </div>
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Fashion Plastic Chair</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx450,000.00</span>
                                                            {{-- <span class="old__price">UGx200.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Fashion Plastic Chair</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx250,000.00</span>
                                                            {{-- <span class="old__price">UGx200.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Modern Swivel Chair</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx260,000.00</span>
                                                            {{-- <span class="old__price">UGx210.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Design Living Sofa</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx155,000.00</span>
                                                            {{-- <span class="old__price">UGx205.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Plastic Chair Wooden</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx190,000.00</span>
                                                            {{-- <span class="old__price">UGx200.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Folding Tables Chairs</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx175,000</span>
                                                            {{-- <span class="old__price">UGx190.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                            ...
                                            <div class="col mb-30 d-xl-none d-xxl-block">
                                                <div class="product__items ">
                                                    ...
                                                    <div class="product__items--content text-center">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="{{ route('product.detail') }}">Modern Fabric Chair</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">UGx165,000.00</span>
                                                            {{-- <span class="old__price">UGx210.00</span> --}}
                                                        </div>
                                                        <a class="product__items--action__cart--btn primary__btn" href="cart.html">
                                                            <svg class="product__items--action__cart--btn__icon" xmlns="http://www.w3.org/2000/svg" width="13.897" height="14.565" viewBox="0 0 18.897 21.565">
                                                ...
                                                <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                    <div class="product__list--items__left d-flex align-items-center">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            ...
                                                            <h4 class="product__list--items__content--title mb-15"><a href="{{ route('product.detail') }}">Larger Minimal Wooden Chair</a></h4>
                                                    ...
                                                    <div class="product__list--items__right">
                                                        <span class="product__list--current__price">UGx299,000.00</span>
                                                ...
                                                <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                    <div class="product__list--items__left d-flex align-items-center">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            ...
                                                            <h4 class="product__list--items__content--title mb-15"><a href="{{ route('product.detail') }}">White Minimalist Combo Sofa</a></h4>
                                                            <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                        </div>
                                                    </div>
                                                    <div class="product__list--items__right">
                                                        <span class="product__list--current__price">UGx320,000.00</span>
                                                        <ul class="rating product__list--rating d-flex">
                                                            <li class="rating__list">
                                                                <span class="rating__list--icon">
                                                                    <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="11.105" height="11.732" viewBox="0 0 10.105 9.732">
                                                ...
                                                <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                    <div class="product__list--items__left d-flex align-items-center">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            ...
                                                            <h4 class="product__list--items__content--title mb-15"><a href="{{ route('product.detail') }}">Modern Swivel Chair</a></h4>
                                                            <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                        </div>
                                                    </div>
                                                    <div class="product__list--items__right">
                                                        <span class="product__list--current__price">UGx280,000</span>
                                                        <ul class="rating product__list--rating d-flex">
                                                            <li class="rating__list">
                                                                <span class="rating__list--icon">
                                                                    <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="11.105" height="11.732" viewBox="0 0 10.105 9.732">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                    <div class="product__list--items__left d-flex align-items-center">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            <span class="product__items--content__subtitle mb-5">Wooden</span>
                                                            <h4 class="product__list--items__content--title mb-15"><a href="{{ route('product.detail') }}">Modern Stylish Single Sofa</a></h4>
                                                            <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                        </div>
                                                    </div>
                                                    <div class="product__list--items__right">
                                                        <span class="product__list--current__price">UGx255,000.00</span>
                                                        <ul class="rating product__list--rating d-flex">
                                                            <li class="rating__list">
                                                                <span class="rating__list--icon">
                                                                    <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="11.105" height="11.732" viewBox="0 0 10.105 9.732">
                                                ...
                                                <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                    <div class="product__list--items__left d-flex align-items-center">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            ...
                                                            <h4 class="product__list--items__content--title mb-15"><a href="{{ route('product.detail') }}">New Furniture Tree Planet</a></h4>
                                                            <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                        </div>
                                                    </div>
                                                    <div class="product__list--items__right">
                                                        <span class="product__list--current__price">UGx275,000.00</span>
                                                        <ul class="rating product__list--rating d-flex">
                                                            <li class="rating__list">
                                                                <span class="rating__list--icon">
                                                                    <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="11.105" height="11.732" viewBox="0 0 10.105 9.732">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                    <div class="product__list--items__left d-flex align-items-center">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            <span class="product__items--content__subtitle mb-5">Wooden</span>
                                                            <h4 class="product__list--items__content--title mb-15"><a href="{{ route('product.detail') }}">Single Stylish Mini Chair</a></h4>
                                                            <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                        </div>
                                                    </div>
                                                    <div class="product__list--items__right">
                                                        <span class="product__list--current__price">UGx310,000.00</span>
                                                        <ul class="rating product__list--rating d-flex">
                                                            <li class="rating__list">
                                                                <span class="rating__list--icon">
                                                                    <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="11.105" height="11.732" viewBox="0 0 10.105 9.732">
        ...
        <section class="newsletter__banner--section section--padding pt-0">
            <div class="container-fluid">
                <div class="newsletter__banner--thumbnail position__relative">
                    <img class="newsletter__banner--thumbnail__img" src="{{ asset('images/banner/banner-bg2.webp') }}" alt="newsletter-banner">
